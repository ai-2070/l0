...
import { l0, openaiStream, openaiText, openaiJSON, openaiWithTools, recommendedGuardrails } from "../src/index";
...
describeIf(hasOpenAI)("OpenAI SDK Direct Integration", () => {
  describe("openaiStream", () => {
    it("should stream with openaiStream helper", async () => {
  ...
  describe("openaiText", () => {
    it("should stream with string prompt", async () => {
      const result = await l0({
        stream: openaiText(client!, "gpt-4o-mini", "What is 2+2? Answer with just the number."),
      });
    ...
    it("should stream with messages array", async () => {
      const result = await l0({
  ...
  describe("With Guardrails", () => {
    it("should work with guardrails", async () => {
      const result = await l0({
  ...
  describe("Usage Tracking", () => {
    it("should include usage in done event", async () => {
      let usage: any;
